    ...
    <div className="fixed inset-0 z-40 bg-[#0f0f0f] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 space-y-1">
        {templates.length === 0 ? (
          ...
          <>
            <Section title="Sugeridas hoje" items={suggested} sectionKey="suggested" />
            <Section title="Recentes" items={recent} sectionKey="recent" />
            <Section title="Biblioteca" items={rest} sectionKey="all" />
          </>
        )}
